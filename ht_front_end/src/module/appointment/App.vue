...
<div id="app" style="width:100%;height:100%">
  ...
  <div class="div-border">
    ...
    <item_input_txt ref="ref_child_name" title="学员姓名：" :disabled=textDisable v-model="form.child_name" hint="请填写学员姓名"></item_input_txt>
    <item_input_mon ref="ref_child_birthday" title="学员年龄：" :disabled=textDisable v-model="form.child_birthday" placeholder="输入学员年龄" hint="请输入正确的年龄(3-100)"></item_input_mon>
