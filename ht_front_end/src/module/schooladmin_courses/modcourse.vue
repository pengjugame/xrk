<template>
	...
	<div class="mui-card">
		<router-link class="mui-action-back mui-icon mui-icon-left-nav mui-pull-left" :to="{ name:'courses'}" tag="a" ></router-link>
	</div>
	...
	<div class="mui-card" >
		...
		<div class="mui-card-content mui-input-group ">
			...
			<div class="mui-input-row">
				<label>课程名称：</label>
				<input type="text"  v-model="course.coursename" class="mui-input-clear" placeholder="请输入课程名" >
			</div>
			
			<div class="mui-input-row">
				<label>课程简介：</label>
				<input type="text"  v-model="course.coursedetails" class="mui-input-clear" placeholder="请输入课程简介">
			</div>
