...
<div id="app" class="mui-content">
  <nav class="mui-bar mui-bar-tab">
    ...
    <a class="mui-tab-item" href="#classsview">
  ...
  <div class="mui-card" v-for="student in students" >
    ...
    <div class="mui-card-content mui-input-group ">
      ...
      <div class="mui-input-row">
        <label>性别：</label> 
        <input name="text" v-if="student.studentusex == '0'" value="男" readonly>
  ...
  <div id="classsview" class="mui-control-content">
  <div class="mui-card" v-for="cla in classes" >
    ...
    <div class="mui-card-content mui-input-group ">
      ...
      <div class="mui-input-row" >
        <label>课程介绍：</label>
        <input type="text" v-model="cla.coursedetails" readonly>
			</div>
    </div>

    <div class="mui-card-footer">
      <label>课程最大人数: {{cla.coursemaxnumusers}}</label>
      <a class="mui-action-back mui-btn mui-btn-link mui-pull-right">班级剩余人数：{{cla.coursemaxnumusers}}-{{cla.classstudentnum}}</a>
    </div>
  </div>
  </div>
