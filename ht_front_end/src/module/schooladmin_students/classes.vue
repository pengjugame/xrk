  ...
  <div class="mui-content">
    <div class="mui-card">
      <ul class="mui-table-view">
        <li class="mui-table-view-cell mui-collapse" v-for="cla in classes" >
          <a class="mui-navigate-right" href="#">
            {{cla.classname}}&nbsp;
            <span class="mui-badge mui-badge-warning">{{cla.classnumusers}}</span>
          </a>
            <div class="mui-collapse-content">
              <form class="mui-input-group">
                ...
                <div class="mui-button-row">
                  <router-link class="mui-btn mui-btn-warning " :to="{ name:'classstudents', params: cla }" tag="button" >学生管理</router-link>
                </div>
              </form>
            </div>
        </li>
