<template>
  ...
  <div class="mui-card-header" style="height: 40px" >
    ...
    <router-link class=" mui-btn mui-btn-success mui-icon mui-icon-paperclip mui-pull-right" :to="{ name:'workclasses', params: {classid:classid} }" tag="a" >开课记录</router-link>
  </div>
