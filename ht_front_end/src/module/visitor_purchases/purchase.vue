  ...
  <div class="mui-card" >
    ...
    <div class="mui-card-content mui-input-group ">
      ...
      <div class="mui-input-row" style="height: 70px" >
        <label>预购备注：</label>
        <textarea type="text" rows="2" v-model.trim="form.purchasedetails" class="mui-input-clear" placeholder="请输入预购备注" />
      </div>
...
export default {
  ...
  this.form.purchaseactive = '';

  if(this.$route.params.classcardid != undefined)
    this.classcardid = this.$route.params.classcardid;

  if(this.$route.params.classcardname != undefined)
