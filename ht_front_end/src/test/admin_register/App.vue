...
<div id="app" style="width:100%;">
  <img style="width:100%" src="./admin_register_header.png" />
  ...
  <div class="div-border">
    ...
    <div style="height:15px;"></div>
    <item_input_gen ref="ref_gen" title="性别：" style_label="position:relative;left:6px;letter-spacing: 15px;" :disabled=textDisable v-model="form.sex"></item_input_gen>
    <div style="height:15px;"></div>
