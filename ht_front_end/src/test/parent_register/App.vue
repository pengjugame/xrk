...
<div id="app" style="width:100%,height:100%">
  ...
  <div class="div-border">
    ...
    <div style="height:15px;"></div>
    <item_input_txt ref="ref_child_name" title="学员姓名：" :disabled=textDisable v-model="form.child_name" hint="学员姓名是必填项"></item_input_txt>
    <div style="height:15px;"></div>
    <item_input_mon ref="ref_child_birthday" title="学员年龄：" :disabled=textDisable v-model="form.child_birthday" placeholder="输入学员多大了" hint="请输入正确的年龄(3-100)"></item_input_mon>
    <div style="height:15px;"></div>
    <item_input_gen ref="ref_gen" title="学员性别：" :disabled=textDisable v-model="form.sex"></item_input_gen>
    <div style="height:15px;"></div>
  </div>
