        ...
        */
        ...
        if (res_have_result(teachers_res)) {
            ...
            n.title = checkin
                ? "学员上学了"
                : "学员放学了";
            n.description = teacher.name + "老师，请确认下是哪个学员" + (checkin
                ? "到学校了"
                : "离开学校了");
            return n;
        }
        ...
        if (!res_have_result(child_res)) {
            return Promise.reject(new Error("指定的学员数据不存在"));
        }
        ...
        if (res_have_result(r)) {
            ...
            n.description = parent.name + "家长，" + child_res.result[0].name + "学员" + (checkin
                ? "到学校了"
                : "离开学校了");
...
var child_check_data = function(childid, key, openid) {
    return co(function * () {
        ...
        //    ? 'checkin'
        //    : 'checkout', school_res.result[0], child_res.result[0], 0.01, child_res.result[0].name + "学员已经" + (check_data.type == 0
        //    ? "到校"
